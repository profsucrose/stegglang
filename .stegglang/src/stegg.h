...
#define endofstegg }
#define addsteggpoint steggpoint+=1;
#define losesteggpoint steggpoint-=1;
#define addsteggpoint2 steggpoint2+=1;
#define losesteggpoint2 steggpoint2-=1;
...
#define steggystopssaying << std::endl;
